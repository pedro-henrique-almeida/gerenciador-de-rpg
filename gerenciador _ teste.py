...
Versão com inventário, troca de armas e menu integrado
"""

from builtins import ValueError, input, int, print
import random
...
def iniciar_combate():  # em produçao
    ...
    participantes = []  # armanzena quem esta no comabate
    ...
    while True:
        ...
        try:
            participante = integrantes[participante - 1]
        except IndexError:
            print("Opção inválida.")
            continue
        ...
        print(f"{participante['nome']} adicionado ao combate.")
    ...
    print("\n=== COMBATE INICIADO NO LOCAL:", cenario["nome"], "===")
    print("\n=== PARTICIPANTES DO COMBATE ===")
    for participante in participantes:
        print(f"Participante: {participante['nome']}")


cenarios = []  # armazena o nome do local e os participantes
...
def ataque(atacante, alvo):
    ...
    while True:
        ...
        if decisao == "S":
            ...
            vida_restante = alvo["vida"] - dano_total
...
def combate_com_alvo():
    ...
    try:
        atacante = ficha_player[escolha_atacante - 1]
    except IndexError:
...
def menu_players():
    while True:
        print("\n=== MENU PLAYERS ===")
        print("1 - Listar Players")
        print("2 - Adicionar Player")
        print("3 - Remover Player")
        print("0 - Voltar")
        try:
...
def menu_combate():
    while True:
        print("\n=== MENU COMBATE ===")
        print("1 - Combate com alvo (contra criatura)")
        print("2 - Combate livre (sem alvo)")
        print("3 - Rolagem livre (teste de atributo)")
        print("0 - Voltar")
        try:
            opcao = int(input("Escolha: "))
        except ValueError:
